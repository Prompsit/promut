    ...
    def get_value(self, mt_path, ht_path, source_path = ""):
        ...
        with app.app_context():
            ...
            if gpu_id is not None:
                ...
                comet = subprocess.run("pymarian-eval -m wmt22-comet-da -l comet -t {0} {1} -r {2} --average only {3} --workspace 3000 --mini-batch 1".format(mt_path, src_path, ht_path, device_command), 
